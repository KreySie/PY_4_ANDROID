...
class PaginaPrincipalState extends State<PaginaPrincipal> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new GridView.extent(maxCrossAxisExtent: 150.0, mainAxisSpacing: 5.0, crossAxisSpacing: 5.0, padding: const EdgeInsets.all(5.0), children: _buildGridTiles(21)), //Fin de gridView
    ); //Fin Scaffold
  } //Fin de widget
